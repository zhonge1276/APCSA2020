...
public class StartPanel extends JPanel
{
	...
	private JRadioButton danceRadio;
	private String danceClue;
	...
	public StartPanel(CelebrityGame controller)
	{
		...
		this.danceRadio = new JRadioButton("Dance");
		this.danceClue = "Enter the clues for the dance celeb separated by commas ";
	...
	private void setupLayout()
	{
		...
		panelLayout.putConstraint(SpringLayout.NORTH, literatureRadio, 10, SpringLayout.SOUTH, danceRadio);
		panelLayout.putConstraint(SpringLayout.WEST,danceRadio, 0, SpringLayout.WEST, celebrityRadio);
		panelLayout.putConstraint(SpringLayout.NORTH, danceRadio, 10, SpringLayout.SOUTH, celebrityRadio);
	...
	private void setupListeners()
	{
		...
		danceRadio.addActionListener(select -> clueLabel.setText(danceClue));

...
public class StartPanel extends JPanel
{
	...
	public StartPanel(CelebrityGame controller)
	{
		...
		this.danceRadio = new JRadioButton("dance Celebrity");
	...
	private void setupLayout()
	{
		...
		panelLayout.putConstraint(SpringLayout.NORTH, danceRadio, 10, SpringLayout.SOUTH, literatureRadio);
		panelLayout.putConstraint(SpringLayout.WEST, danceRadio, 0, SpringLayout.WEST, literatureRadio);
